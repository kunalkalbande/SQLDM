...
rem _____________________________________________________________________
"c:\program files\Absolute Packager\absolute.exe" /abs InstallationKit-ia64.abs /build Temp\IderaSQLdmInstallationKit-ia64.exe /silent /zip Temp\SQLdm-ia64.zip
