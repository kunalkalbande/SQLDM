...
rem _____________________________________________________________________
"c:\program files\Absolute Packager\absolute.exe" /abs InstallationKit-x64.abs /build Temp\Trial\IderaSQLdmInstallationKit-x64.exe /silent /zip Temp\Trial\SQLdm-x64.zip
