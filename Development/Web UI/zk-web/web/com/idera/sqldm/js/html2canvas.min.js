...
(function(t, u, l) {
    ...
    i.Util.getCSS = function(c, g) {
        ...
        var a;
        if (t.getComputedStyle) void 0 !== c && (T = u.defaultView.getComputedStyle(c, null)), a = T[g], g === "backgroundPosition" && (a = (a.split(",")[0] || "0 0").split(" "), a[0] = a[0].indexOf("%") ===
    ...
    i.Parse = function(c, g) {
        ...
        function P(a, b, c) {
            ...
            if (/^(submit|reset|button|text|password)$/.test(a.type) ||
                a.nodeName === "SELECT") d.style.lineHeight = y(a, "height");
        ...
        function x(a, b, c, d, e, g, f) {
            ...
            for (j = d + c.left; j < g + d;) h = Math.floor(j + b.width) >
        ...
        function K(b, c) {
            ...
            if (g.useOverflow === !0 &&
                /(hidden|scroll|auto)/.test(y(b, "overflow")) === !0 && /(BODY)/i.test(b.nodeName) === !1) r.clip = r.clip ? n(r.clip, j) : j;
            t = q.children.push(r);
            ...
            switch (b.nodeName) {
                ...
                case "LI":
                    ...
                    if (/^(decimal|decimal-leading-zero|upper-alpha|upper-latin|upper-roman|lower-alpha|lower-greek|lower-latin|lower-roman)$/i.test(m)) {
                        ...
                        if (f === "inside") R.setVariable("textAlign", "left"), j = j.left, f = r.bottom, B = R, h(F).length > 0 && (B.fillText(F,
                            j, f), H += 1)
                    }
                    break;
                case "CANVAS":
        ...
        function G(a, b) {
            if (y(a, "display") !== "none" && y(a, "visibility") !== "hidden" && (b = K(a, b) || b, R = b.ctx, !A.test(a.nodeName))) {
                var c = i.Util.Children(a),
                    d, e, j;
                d = 0;
                for (j = c.length; d < j; d += 1) e = c[d], e.nodeType === 1 ? G(e, b) : e.nodeType ===
                    3 && f(a, e, b)
            }
        }
        t.scroll(0, 0);
        ...
        B.svgRendering && function(a) {
            ...
            c.src = ["data:image/svg+xml,", "<svg xmlns='http://www.w3.org/2000/svg' version='1.1' width='" +
                d.width + "' height='" + d.height + "'>", "<foreignObject width='" + d.width + "' height='" + d.height + "'>", "<html xmlns='http://www.w3.org/1999/xhtml' style='margin:0;'>", j.replace(/\#/g, "%23"), "</html></foreignObject></svg>"
            ].join("");
            c.onload = function() {
                S.svgRender = c
            }
    ...
    i.Preload = function(c) {
        ...
        function a(c) {
            ...
            if (k === 1 || k === l) {
                ...
                h &&
                    h !== "1" && h !== "none" && (/^(-webkit|-o|-moz|-ms|linear)-/.test(h) ? (c = i.Generate.Gradient(h, i.Util.Bounds(c)), c !== l && (b[h] = {
                        img: c,
                        succeeded: !0
        ...
        f = {
            loadImage: function(a) {
                var f, g;
                if (a && b[a] === l) f = new Image, a.match(/data:image\/.*;base64,/i) ? (f.src = a.replace(/url\(['"]{0,}|['"]{0,}\)$/ig,
                    ""), g = b[a] = {
                    img: f
            ...
            _create: function(b, c, h, i, t) {
                ...
                if (c.svgRendering && b.svgRender !== l) v.drawImage(b.svgRender, 0, 0);
                    ...
                    for (G = i.length; K < G; K += 1) {
                        ...
                        if (x.ctx.storage) {
                            B = 0;
                            for (z = x.ctx.storage.length; B < z; B += 1) switch (A =
