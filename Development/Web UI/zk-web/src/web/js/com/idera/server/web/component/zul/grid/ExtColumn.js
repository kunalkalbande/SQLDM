...
com.idera.server.web.component.zul.grid.ExtColumn = zk.$extends(zul.grid.Column, {
	
	getZclass: function () {
		var zcls = this._zclass;
		return zcls != null ? zcls : 'z-column';
	},
