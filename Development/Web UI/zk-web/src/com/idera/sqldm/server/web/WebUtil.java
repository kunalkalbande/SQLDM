...
import com.idera.sqldm.ui.components.CustomMessageBox;
import com.idera.sqldm.ui.components.CustomMessageBox.UserResponse;
...
public class WebUtil {
	...
	public static void showErrorBox(boolean suspendExecution, Throwable ex,
		...
		showBox(suspendExecution, msg, exStrings, title, Messagebox.ERROR, Arrays.asList(UserResponse.OK), false, null, false);
	...
	public static void showMessageListErrorBox(List<String>exStrings, String msgKey, Object... varargs) {
		...
		showBox(false, msg, exStrings, title, Messagebox.ERROR, Arrays.asList(UserResponse.OK), true, null, false);
	...
	public static boolean showConfirmationBoxWithWarning(String msgKey, String title,
			Object... varargs) {
		return UserResponse.YES.equals(showMessageBox(true, Arrays.asList(msgKey), title, Messagebox.EXCLAMATION, Arrays.asList(UserResponse.YES, UserResponse.NO), true, varargs)) ? true : false;
	}

	public static UserResponse showBoxPreFormated(String msgKey, String title, String icon, Object... varargs) {
		return showMessageBox(false, Arrays.asList(msgKey), title, icon, Arrays.asList(UserResponse.OK), false, varargs);
	}
	...
	public static boolean showConfirmationBoxWithIcon(String msgKey, String title, String icon, boolean formatMessage, Object... varargs) {
		return UserResponse.YES.equals(showMessageBox(true, Arrays.asList(msgKey), title, icon, Arrays.asList(UserResponse.YES, UserResponse.NO), formatMessage, varargs)) ? true : false;
	}
	
	public static UserResponse showMessageBox(boolean suspendExecution, List<String> msgKey, String title, String iconURL, List<UserResponse> userResponseList, boolean translateMessages, Object... varargs) {
	 ...
	 */
	public static UserResponse showBox(boolean suspendExecution, String primaryFailureMessage, List<String> msgKey,
			String title, String iconURL, List<UserResponse> userResponseList, boolean translateMessages,
		...
		return window.getAttribute(CustomMessageBox.USER_RESPONSE) == null || !(window.getAttribute(CustomMessageBox.USER_RESPONSE) instanceof UserResponse) 
				? UserResponse.OK 
						: (UserResponse) window.getAttribute(CustomMessageBox.USER_RESPONSE);
	}
...
*/	
	...
	public static String buildPathRelativeToProduct(Product product, String path){
		if(product == null){
			logger.error(com.idera.sqldm.i18n.SQLdmI18NStrings.CURRENT_PRODUCT_IS_NULL);
			return path;
		}
