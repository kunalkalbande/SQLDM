...
public class LicenseTypeConverter  implements TypeConverter{
	@Override
	...
	public Object coerceToUi(Object obj, Component comp) {
		...
		return (ld.isTrial() ? ELFunctions.getLabel(I18NStrings.LICENSE_TYPE_TRIAL) : ELFunctions.getLabel(I18NStrings.LICENSE_TYPE_PERMANENT));
	}
}
