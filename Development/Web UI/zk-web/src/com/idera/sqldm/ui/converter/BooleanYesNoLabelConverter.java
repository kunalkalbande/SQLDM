...
public class BooleanYesNoLabelConverter implements TypeConverter {
	...
	public Object coerceToUi(Object obj, Component comp) {
		...
		return (Boolean) obj ? ELFunctions.getLabel(I18NStrings.YES) : ELFunctions.getLabel(I18NStrings.NO);
	}
