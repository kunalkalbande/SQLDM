...
public class CommaSeparatedPercentageLabelForMVVMConverter implements Converter {

	private Logger log = Logger.getLogger(CommaSeparatedPercentageLabelForMVVMConverter.class);
