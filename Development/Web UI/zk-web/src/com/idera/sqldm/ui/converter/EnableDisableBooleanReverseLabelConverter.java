...
public class EnableDisableBooleanReverseLabelConverter implements TypeConverter {
	...
	public Object coerceToUi(Object obj, Component comp) {
		...
		return (Boolean) obj ? ELFunctions.getLabel(I18NStrings.DISABLE) : ELFunctions.getLabel(I18NStrings.ENABLE);
	}
