...
public enum RestMethods {
	...
	GET_PRESCREPTIVE_ANALYSIS("/Instances/{INSTANCEID}/recommendations/listing"), //PA Added
	GET_PRESCREPTIVE_ANALYSIS_DETAILS("/Instances/{INSTANCEID}/recommendations/{ANALYSISID}/details"); //PA Added
