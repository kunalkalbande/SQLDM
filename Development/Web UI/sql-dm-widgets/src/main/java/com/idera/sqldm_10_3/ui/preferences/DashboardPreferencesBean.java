...
import com.idera.sqldm_10_3.ui.dashboard.DashboardInstanceViewComposer.FilterType;
import com.idera.sqldm_10_3.ui.dashboard.DashboardInstanceViewComposer;
...
public class DashboardPreferencesBean extends IPreferencesBean {
	...
	public static enum DashboardCategoryGroup {
		SEVERITY("severity", DashboardInstanceViewComposer.FilterType.STATUS),
		TAGS("tags", DashboardInstanceViewComposer.FilterType.TAG);

		private String type;
		private DashboardInstanceViewComposer.FilterType filterType;
		private String name;
		
		private DashboardCategoryGroup(String type, DashboardInstanceViewComposer.FilterType filterType) {
			this.type = type;
		...
		public DashboardInstanceViewComposer.FilterType getFilterType() {
			return filterType;
		}

		public void setFilterType(DashboardInstanceViewComposer.FilterType filterType) {
			this.filterType = filterType;
		}
