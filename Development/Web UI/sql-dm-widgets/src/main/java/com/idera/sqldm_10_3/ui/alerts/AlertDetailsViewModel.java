...
import com.idera.sqldm_10_3.ui.components.charts.line.IderaLineChartModel;
import com.idera.sqldm_10_3.ui.components.charts.line.IderaLineChart;
...
public class AlertDetailsViewModel extends SelectorComposer<Window> {
	...
	@Wire
    private Window alertDetailsWindow;
...
/*		String productInstanceName = Utility.getUrlParameter(Executions
		...
		try {
			this.alert = AlertFacade.getAlert(productInstanceName, alertId);
