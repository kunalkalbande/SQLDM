...
public class InstanceDetailsDatabase {
	...
	public static HashMap<String, ArrayList<String>> getMap() {
		...
		map.put(com.idera.sqldm_10_3.i18n.SQLdmI18NStrings.DATABASE_CREATION_DATE, columnsList);

		columnsList = new ArrayList<>();
		columnsList.add("getCurrentDataSizeInMb");
		map.put(com.idera.sqldm_10_3.i18n.SQLdmI18NStrings.DATABASE_DATA_SIZE, columnsList);

		columnsList = new ArrayList<>();
		columnsList.add("getCurrentLogFileSizeInMb");
		map.put(com.idera.sqldm_10_3.i18n.SQLdmI18NStrings.DATABASE_LOG_SIZE, columnsList);
