package com.idera.sqldm_10_3.io.executor;

import com.idera.common.UIWorkerThread;
import com.idera.sqldm_10_3.io.executor.ParallelExecutionsPDU.PDUBean;
import com.idera.sqldm_10_3.io.executor.ParallelExecutionsPDU.PDUBeanCallable;
...
public class ParallelExecutions {
	...
	public void invokeAll() throws Exception {
		...
		com.idera.sqldm_10_3.server.web.session.SessionUtil.setSessionVariable("sc", sc);
