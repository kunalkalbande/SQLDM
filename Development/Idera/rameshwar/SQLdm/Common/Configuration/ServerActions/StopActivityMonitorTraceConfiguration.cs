...
namespace Idera.SQLdm.Common.Configuration.ServerActions
{
    ...
    /// </summary>
    [Serializable]
    public class StopActivityMonitorTraceConfiguration : OnDemandConfiguration, IServerActionConfiguration
    {
        #region fields
        ...
        public StopActivityMonitorTraceConfiguration(int monitoredServerId)
