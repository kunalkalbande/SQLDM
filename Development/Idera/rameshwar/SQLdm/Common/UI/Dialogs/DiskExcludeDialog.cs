...
{
    public partial class DiskExcludeDialog : Form
    {
        ...
        private static BBS.TracerX.Logger LOG = BBS.TracerX.Logger.GetLogger("Common.UI.Dialogs.DiskExcludeDialog");
        ...
        public DiskExcludeDialog(SqlConnectionInfo connectionInfo)
            : this()
        {
        ...
        public DiskExcludeDialog(SqlConnectionInfo connectionInfo, int serverInstanceId, string serverInstanceName, bool multiselect, bool selectionRequired, string descriptionLabelText, string title)
        ...
        public DiskExcludeDialog(IManagementService managementService, int serverInstanceId, string serverInstanceName, bool multiselect, bool selectionRequired, string descriptionLabelText, string title)
            : this(serverInstanceId, serverInstanceName, multiselect, selectionRequired, descriptionLabelText)
        {
            this.Text = title;
        ...
        public DiskExcludeDialog(IManagementService managementService, int serverInstanceId, string serverInstanceName, bool multiselect, bool selectionRequired, string descriptionLabelText)
            : this(serverInstanceId, serverInstanceName, multiselect, selectionRequired, descriptionLabelText)
        {
            this.managementServiceInterface = managementService;
        }

        public DiskExcludeDialog(int serverInstanceId, string serverInstanceName, bool multiselect, bool selectionRequired, string descriptionLabelText)
            : this()
        {
