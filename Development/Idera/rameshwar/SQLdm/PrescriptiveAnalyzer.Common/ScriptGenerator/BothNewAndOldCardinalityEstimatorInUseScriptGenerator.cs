...
namespace Idera.SQLdm.PrescriptiveAnalyzer.Common.ScriptGenerator
{
    ...
    /// </summary>
    public class BothNewAndOldCardinalityEstimatorInUseScriptGenerator : IScriptGenerator, IUndoScriptGenerator
    {
        public List<DbWithCompatibility> DbWithCompatibilityLowerThan120 { get; set; }
        private int defaultCompatibility = 120;

        public BothNewAndOldCardinalityEstimatorInUseScriptGenerator(List<DbWithCompatibility> dbCompatibilty)
        {
        ...
        public string GetTSqlFix(SqlConnectionInfo connectionInfo)
        {
            ...
            create.AppendLine(ApplicationHelper.GetEmbededResource(GetType().Assembly, "Idera.SQLdm.PrescriptiveAnalyzer.Common.ScriptGenerator.Templates.DisableTrace2312.sql"));
            create.AppendLine(ApplicationHelper.GetEmbededResource(GetType().Assembly, "Idera.SQLdm.PrescriptiveAnalyzer.Common.ScriptGenerator.Templates.DisableTrace9481.sql"));
        ...
        public string GetTSqlUndo(SqlConnectionInfo connectionInfo)
        {
            ...
            create.AppendLine(ApplicationHelper.GetEmbededResource(GetType().Assembly, "Idera.SQLdm.PrescriptiveAnalyzer.Common.ScriptGenerator.Templates.EnableTrace2312.sql"));
            create.AppendLine(ApplicationHelper.GetEmbededResource(GetType().Assembly, "Idera.SQLdm.PrescriptiveAnalyzer.Common.ScriptGenerator.Templates.EnableTrace9481.sql"));
            return (create.ToString());
        }
    }
}
