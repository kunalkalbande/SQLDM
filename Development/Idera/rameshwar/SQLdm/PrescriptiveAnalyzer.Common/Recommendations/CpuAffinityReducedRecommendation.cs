...
{ 
    [Serializable]
    public class CpuAffinityReducedRecommendation : CpuRecommendation, IScriptGeneratorProvider, IUndoScriptGeneratorProvider, IUndoMessageGenerator
    {
        public int TotalCpuCount { get; private set; }
        public int AllowedToUseCpuCount { get; private set; }
        public int PreviousAllowedToUseCpuCount { get; private set; }
        public int CpuUsagePercent { get; private set; }
        public ulong? ObservedAffinityMask { get; private set; }

        public CpuAffinityReducedRecommendation(RecommendationProperties recProp)
            : base(RecommendationType.CpuAffinityReduced, recProp)
        {
            TotalCpuCount = recProp.GetInt("TotalCpuCount");
            AllowedToUseCpuCount = recProp.GetInt("AllowedToUseCpuCount");
            PreviousAllowedToUseCpuCount = recProp.GetInt("PreviousAllowedToUseCpuCount");
            CpuUsagePercent = recProp.GetInt("CpuUsagePercent");
            ObservedAffinityMask = recProp.GetNullableULong("ObservedAffinityMask");
        }
        
        public CpuAffinityReducedRecommendation(int cpuCount, int allowedCount, int previousAllowedCount, int cpuUsagePercent, ulong observedAffinityMask)
            : base(RecommendationType.CpuAffinityReduced)
        {
            TotalCpuCount = cpuCount;
            AllowedToUseCpuCount = allowedCount;
            PreviousAllowedToUseCpuCount = previousAllowedCount;
        ...
        public override Dictionary<string, string> GetProperties()
        {
            ...
            prop.Add("PreviousAllowedToUseCpuCount", PreviousAllowedToUseCpuCount.ToString());
        ...
        new public List<string> GetUndoMessages(RecommendationOptimizationStatus res, SqlConnection connection)
        {
            ...
            {
                ExceptionLogger.Log(LOG, "CPUAffinityReducedRecommedation GetUndoMessages failed: ", ex);
            }
            return messages;
        }
    }
