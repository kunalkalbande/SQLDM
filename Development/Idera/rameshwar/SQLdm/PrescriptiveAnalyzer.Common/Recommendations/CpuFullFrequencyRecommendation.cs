...
{
    [Serializable]
    public class CpuFullFrequencyRecommendation : CpuRecommendation
    {
        ...
        public CpuFullFrequencyRecommendation(double avgFreqPercent)
            : base(RecommendationType.CpuFullFrequency)
        {
            AvgFrequencyPercent = avgFreqPercent;
        }

        public CpuFullFrequencyRecommendation(RecommendationProperties recProp)
            : base(RecommendationType.CpuFullFrequency, recProp)
        {
