...
using Idera.SQLdoctor.Common.Resources;
using TracerX;
using System.IO;
...
namespace Idera.SQLdoctor.Common.Configuration
{
    ...
    public class ServerConfiguration
    {
        ...
        public ServerConfiguration() : this(new SqlConnectionInfo())
        {

        }

        public ServerConfiguration(SqlConnectionInfo connectionInfo)
        {
        ...
        public static ServerConfiguration DeserializeXml(XmlNode element)
        {
            ...
            try
            {
                ...
                serverConfiguration = new ServerConfiguration(SqlConnectionInfo.DeserializeXml(connectionInfoNode));
            }
            catch
            {
