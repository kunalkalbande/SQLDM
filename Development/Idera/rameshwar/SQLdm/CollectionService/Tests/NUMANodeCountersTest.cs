...
namespace Idera.SQLdm.CollectionService.Tests
{
    ...
    {
        [TestCase]
        public void NUMANodeCountersBatchfinder2000Test()
        {
            ServerVersion ver;
            string batch;
            ver = new ServerVersion(TestCaseHelper.Version2000);
            batch = BatchFinder.NUMANodeCounters(ver, null);
            Assert.IsNullOrEmpty(batch);
        }

        [TestCase]
        public void NUMANodeCountersBatchfinder2005Test()
        {
            ServerVersion ver;
            string batch;
            ...
            string expectedBatch = BatchFinder.GetBatchForTest("NUMANodeCounters2005.sql");
            Assert.AreEqual(expectedBatch, batch);
        }

        [TestCase]
        public void NUMANodeCountersBatchfinder2008Test()
        {
            ServerVersion ver;
            string batch;
        ...
        [TestCase]
        public void NUMANodeCountersBatchfinder2008R2Test()
        {
            ServerVersion ver;
            string batch;
        ...
        [TestCase]
        public void NUMANodeCountersBatchfinder2012Test()
        {
            ServerVersion ver;
            string batch;
        ...
        [TestCase]
        public void NUMANodeCountersBatchfinder2014Test()
        {
            ServerVersion ver;
            string batch;
        ...
        [TestCase]
        public void NUMANodeCountersBuildCommandTest()
        {
            ...
            SqlCommand sqlCommActual = Idera.SQLdm.CollectionService.Probes.Sql.SqlCommandBuilder.BuildNUMANodeCountersCommand(sqlConn, version, null);
            Assert.IsNotNull(sqlCommActual);
            Assert.IsNotEmpty(sqlCommActual.CommandText);
        }

        [TestCase]
        public void NUMANodeCountersProbeTest()
        {
            string[] expectedColumns = new string[] { "NodeName", "PLE", "TargetPages" };
            OnDemandCollectionContext<NUMANodeCountersSnapshot
                > context = new OnDemandCollectionContext<NUMANodeCountersSnapshot>();
            col.CollectNUMANodeCounters(monitoredServerId, context, null);
            var snapshot = context.Wait();
            var baseSnapshot = (NUMANodeCountersSnapshot)snapshot;
            {
