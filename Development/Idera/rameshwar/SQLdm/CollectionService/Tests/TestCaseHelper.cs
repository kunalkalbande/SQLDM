...
namespace Idera.SQLdm.CollectionService.Tests
{
    ...
    {
        public const string Version2000 = "8.0.0";
        public const string Version2005 = "9.0.0";
        public const string Version2008 = "10.0.0";
        public const string Version2008R2 = "10.50.0";
        public const string Version2012 = "11.0.0";
        public const string Version2014 = "12.0.0";
        ...
        public static string SnapshotErrorMessage = "Snapshot.Error is expected to be null but Snapshot has an error attached to it";
        public static string CollectionFailedMessage = "Snapshot.CollectionFailed is true i.e. collection has failed";
        public static string TableNullMessage="Output table is null";
        public static string GetColumnNameMissingError(string col)
        {
            return string.Format("Column {0} is missing from output datatabel", col);
        }
        ...
        private static MonitoredSqlServer ConstructMonitoredSqlServer(SqlDataReader dataReader)
        {
            ...
            QueryMonitorConfiguration queryMonitorConfiguration = new QueryMonitorConfiguration(
                ...
                (bool)dataReader["QueryMonitorQueryStoreMonitoringEnabled"]);  // SQLdm 10.4 (Varun Chopra) Enable Query Monitor using Query Store
        ...
        private static IList<MetricThresholdEntry> GetMetricThresholds(SqlDataReader reader)
        {
            ...
            while (reader.Read())
            {
                ...
                MetricThresholdEntry entry = new MetricThresholdEntry(sqlServerId, metricID, thresholdInstanceName, warning, critical, info);
                entry.Data = data;
