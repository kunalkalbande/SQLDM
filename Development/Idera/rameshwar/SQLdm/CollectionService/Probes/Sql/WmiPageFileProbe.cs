...
namespace Idera.SQLdm.CollectionService.Probes.Sql
{
    ...
    /// </summary>
    class WmiPageFileProbe: SqlBaseProbe
    {
        #region fields

        private WmiPageFileSnapshot snapshot = null;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WmiPageFileProbe"/> class.
        /// </summary>
        ...
        public WmiPageFileProbe(SqlConnectionInfo connectionInfo, WmiConfiguration configuration, int? cloudProviderId)
            : base(connectionInfo)
        {
            LOG = Logger.GetLogger("WmiPageFileProbe");
            snapshot = new WmiPageFileSnapshot(connectionInfo.InstanceName);
        ...
        private void StartDirectCollector()
        {
            ...
            _wmicollector.Query = new WqlObjectQuery("select Name from Win32_PageFileUsage");
                ...
                if (result != null && result.Count > 0)
                {
                    foreach (ManagementBaseObject mbo in result)
                    {
                        try
                        {
                            ...
                            snapshot.WmiPageFile.Rows.Add(name);
                        }
