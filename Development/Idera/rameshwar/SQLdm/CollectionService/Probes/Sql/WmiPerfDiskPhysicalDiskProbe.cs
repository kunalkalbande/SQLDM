...
namespace Idera.SQLdm.CollectionService.Probes.Sql
{
    ...
    /// </summary>
    class WmiPerfDiskPhysicalDiskProbe: SqlBaseProbe
    {
        #region fields

        private WmiPerfDiskPhysicalDiskSnapshot snapshot = null;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WmiPerfDiskPhysicalDiskProbe"/> class.
        /// </summary>
        ...
        public WmiPerfDiskPhysicalDiskProbe(SqlConnectionInfo connectionInfo, WmiConfiguration configuration, int? cloudProviderId)
            : base(connectionInfo)
        {
            LOG = Logger.GetLogger("WmiPerfDiskPhysicalDiskProbe");
            snapshot = new WmiPerfDiskPhysicalDiskSnapshot(connectionInfo.InstanceName);
        ...
        private void StartDirectCollector()
        {
            ...
            _wmicollector.Query = new WqlObjectQuery("select Name, Frequency_Sys100NS, Timestamp_Sys100NS, DiskTransfersPerSec from Win32_PerfRawData_PerfDisk_PhysicalDisk");
            ...
            else
            {
                ...
                if (result != null && result.Count > 0)
                {
                    foreach (ManagementBaseObject mbo in result)
                    {
                        try
                        {
                            var name = WmiCollector.GetPropertyValueOrDefault<uint>(mbo, "Name");
                            ...
                            snapshot.WmiPerfDiskPhysicalDisk.Rows.Add(name, diskTransfersPerSec, frequency_Sys100NS, timestamp_Sys100NS);
                        }
