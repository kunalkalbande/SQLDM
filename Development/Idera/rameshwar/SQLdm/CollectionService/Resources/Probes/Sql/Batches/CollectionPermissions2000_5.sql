...
-- ReplicationCheck2005                                                                
---------------------------------------------------------------------------------------------------
SELECT @PermissionValue = IS_MEMBER('db_ddladmin')
INSERT INTO @PermissionsTable VALUES(
    'DBDDLADMINAccess',
	@PermissionValue
)
...
-- ReplicationCheck2005                                                                
---------------------------------------------------------------------------------------------------
SELECT @PermissionValue = IS_MEMBER('db_owner')
INSERT INTO @PermissionsTable VALUES(
    'DBOWNERAccess',
	@PermissionValue
)
...
-- MirrorMonitoringRealtime2005                                                        
---------------------------------------------------------------------------------------------------
SELECT @PermissionValue = IS_MEMBER('dbm_monitor')
INSERT INTO @PermissionsTable VALUES(
    'DBMMONITORAccess',
	@PermissionValue
)
...
-- No required in SQL 2000 since sys.dm_server_services introduced in 2008
