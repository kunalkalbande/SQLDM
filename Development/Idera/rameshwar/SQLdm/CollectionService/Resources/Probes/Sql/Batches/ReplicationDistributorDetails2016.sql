...
--  Tables: MSreplservers, MSdistribution_status, MSpublications,MSrepl_transactions, 
...
'Distributor' = (select name from MSreplservers where server_id = 0),
...
'SampleTime' = GetUTCDate() into #tempLatency
 ...
 left join MSreplservers pub on s.publisher_id = pub.server_id
 left join MSreplservers sub on s.subscriber_id = sub.server_id
