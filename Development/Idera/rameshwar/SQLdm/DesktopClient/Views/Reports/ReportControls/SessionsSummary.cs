...
{
    public partial class SessionsSummary : ReportContol
    {
        private static readonly Logger Log = Logger.GetLogger("Sessions Summary");
        ...
        public override void InitReport()
        {
            ...
            ReportType = ReportTypes.SessionsSummary;
            RunReport(true);
        }
        ...
        override protected void bgWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            using (Log.DebugCall())
            {
                ...
                dataSource = new ReportDataSource("SessionsSummary");
                dataSource.Value = RepositoryHelper.GetReportData("p_GetSessionsSummary",
                ...
                dataSource = new ReportDataSource("SessionsSummaryBaseline");
                dataSource.Value = RepositoryHelper.GetReportData("p_GetSessionSummaryBaseline",
                                                                  localReportData.instanceID,
                                                                  localReportData.dateRanges[0].UtcStart,
                                                                  localReportData.dateRanges[0].UtcEnd,
                                                                  localReportData.dateRanges[0].UtcOffsetMinutes,
                    ...
                    else
                    {
                        try
                        {
                            ...
                            using (Stream stream = GetType().Assembly.GetManifestResourceStream(
                                "Idera.SQLdm.DesktopClient.Views.Reports.ReportDefinitions.SessionsSummary.rdl"))
                            {
                            ...
                            reportViewer.LocalReport.DisplayName = "SessionSummary";
