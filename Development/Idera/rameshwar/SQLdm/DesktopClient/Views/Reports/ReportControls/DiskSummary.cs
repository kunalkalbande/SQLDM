...
{
    public partial class DiskSummary : Idera.SQLdm.DesktopClient.Views.Reports.ReportControls.ReportContol
    {
        private static readonly Logger Log = Logger.GetLogger("Disk Summary");
        ...
        public override void InitReport()
        {
            ...
            ReportType = ReportTypes.DiskSummary;
            RunReport(true);
        }
        ...
        protected override void SetReportParameters()
        {
            ...
            reportParameters.Add("Interval", sampleSizeCombo.SelectedItem == null ? "1" : ((int)((ValueListItem)sampleSizeCombo.SelectedItem).DataValue).ToString());
        ...
        override protected void bgWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            using (Log.DebugCall())
            {
                ...
                passthroughParameters.Add(new ReportParameter("Interval", (string)localReportData.reportParameters["Interval"]));
                ...
                dataSource = new ReportDataSource("DiskSummary");
                dataSource.Value = RepositoryHelper.GetReportData("p_GetDiskSummary",
                ...
                dataSource = new ReportDataSource("DiskStatisticsBaseline");
                dataSource.Value = RepositoryHelper.GetReportData("p_GetDiskStatisticsBaseline",
                                                                  localReportData.instanceID,
                                                                  localReportData.dateRanges[0].UtcStart,
                                                                  localReportData.dateRanges[0].UtcEnd,
                                                                  localReportData.dateRanges[0].UtcOffsetMinutes,
                    ...
                    else
                    {
                        try
                        {
                            ...
                            using (Stream stream = GetType().Assembly.GetManifestResourceStream(
                                "Idera.SQLdm.DesktopClient.Views.Reports.ReportDefinitions.DiskSummary.rdl"))
                            {
                            ...
                            reportViewer.LocalReport.DisplayName = "DiskSummary";
