...
{
    public partial class VirtualizationSummary : Idera.SQLdm.DesktopClient.Views.Reports.ReportControls.ReportContol
    {
        ...
        public override void InitReport()
        {
            ...
            ReportType = ReportTypes.VirtualizationSummary;
            RunReport(true);
        }
        ...
        public override bool CanRunReport(out string message)
        {
            ...
            {
                message = "A virtualized SQL Server instance must be selected to generate this report.";
                return false;
            }
        ...
        override protected void bgWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            using (Log.DebugCall())
            {
                ...
                //ReportDataSource dataSource = new ReportDataSource("Servers");
                //dataSource.Value = RepositoryHelper.GetReportData("p_GetEnterpriseSummary", true);
                //localReportData.dataSources[0] = dataSource;

                var dataSource = new ReportDataSource("VMConfigData");
                dataSource.Value = RepositoryHelper.GetReportData("p_GetVMConfigReport", localReportData.instanceID);
                localReportData.dataSources[0] = dataSource;

                dataSource = new ReportDataSource("VMSummaryReport");
                dataSource.Value = RepositoryHelper.GetReportData("p_GetVMSummaryReport", 
                    ...
                    else
                    {
                        try
                        {
                            ...
                            using (Stream stream = GetType().Assembly.GetManifestResourceStream(
                                "Idera.SQLdm.DesktopClient.Views.Reports.ReportDefinitions.VirtualizationSummary.rdl"))
                            {
                            ...
                            reportViewer.LocalReport.DisplayName = "VirtualizationSummary";
