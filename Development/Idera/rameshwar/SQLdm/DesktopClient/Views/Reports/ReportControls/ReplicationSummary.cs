...
{
    public partial class ReplicationSummary : ReportContol
    {
        private static readonly Logger Log = Logger.GetLogger("Replication Summary");
        ...
        public override void InitReport()
        {
            ...
            ReportType = ReportTypes.ReplicationSummary;
            RunReport(true);
        }
        ...
        override protected void bgWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            using (Log.DebugCall())
            {
                ...
                dataSource = new ReportDataSource("ReplicationSummary");
                dataSource.Value = RepositoryHelper.GetReportData("p_GetReplicationSummary",
                    ...
                    else
                    {
                        try
                        {
                            ...
                            using (Stream stream = GetType().Assembly.GetManifestResourceStream(
                                "Idera.SQLdm.DesktopClient.Views.Reports.ReportDefinitions.ReplicationSummary.rdl"))
                            {
                            ...
                            reportViewer.LocalReport.DisplayName = "ReplicationSummary";
        ...
        void showBaselineCheckBox_CheckedChanged(object sender, System.EventArgs e)
        {
            SetReportParameters();
        }
    }
