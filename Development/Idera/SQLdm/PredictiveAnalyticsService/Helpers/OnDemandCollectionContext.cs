...
namespace Idera.SQLdm.PredictiveAnalyticsService.Helpers
{
    ...
    {
        private static readonly TimeSpan DEFAULT_WAITTIME  = TimeSpan.FromSeconds(300);
        ...
        public void SetSessionId(Guid sessionId)
        {
            ...
            Dictionary<Guid, ISnapshotSink> sinks = PredictiveAnalyticsService.SnapshotSinks;
