...
namespace Idera.SQLdm.DesktopClient.Controls 
{
    public class CheckedComboBox : ComboBox
    {
        ...
        {
            get { return this.dropdown.HeaderText; }
            set { this.dropdown.HeaderText = value; }
        }
        ...
        internal class Dropdown : Form
        {
            ...
            {
                get { return cbAll.Text; }
                set { cbAll.Text = value; }
            }
            ...
            private void InitializeComponent()
            {
                ...
                this.pnlDivider.BackColor = Color.DarkGray;
                // 
                // cblAll
                // 
                this.cbAll.Dock = DockStyle.Left;
                this.cbAll.CheckedChanged += new EventHandler(cbAll_CheckedChanged);
                // 
                // cclb
                //                 
                ...
                this.cclb.Location = new System.Drawing.Point(0, 20);
                this.cclb.Size = new System.Drawing.Size(50, 80);
                // 
                // Dropdown
                // 
            ...
            private void cbAll_CheckedChanged(object sender, EventArgs e)
            {
                ...
                CheckState newState = cbAll.CheckState;
                CheckState oldState = cbAll.CheckState == CheckState.Checked ? CheckState.Unchecked : CheckState.Checked;

                for (int i = 0; i < cclb.Items.Count; i++)
                {
                    if (cclb.GetItemCheckState(i) == newState)
                        continue;

                    ItemCheckEventArgs args = new ItemCheckEventArgs(i, newState, oldState);
                    cclb.SetItemCheckState(i, newState);

                    if (ccbParent.ItemCheck != null)
                    {
                        cclb.SetItemCheckState(i, newState);
                        ccbParent.ItemCheck(this, args);
                    }
                }
            }
            ...
            private void cclb_ItemCheck(object sender, ItemCheckEventArgs e)
            {
                ...
                int x = cclb.CheckedIndices.Count;
                x += e.NewValue == CheckState.Checked ? 1 : -1;
                cbAll.Checked = x == cclb.Items.Count;
        ...
        public bool InnerDropdownClosed
        {
            get
            {
                if (dropdown != null)
                {
                    return dropdown.DropdownClosed;
                }
                return true;
            }
        }
        ...
        private void DoDropDown()
        {
            if (!dropdown.Visible)
            {
                ...
                int fontSizeProportion = AutoScaleFontHelper.CheckedComboBoxFontSizeProportion;
                ...
                dropdown.Size = new Size(this.DropDownWidth, (dropdown.List.ItemHeight) * count + 22 + fontSizeProportion);
                dropdown.Show(this);
                //dropdown.ShowDialog(this);
                //dropdown.Capture = true;
                //dropdown.Capture = true;
                //SetActiveWindow(dropdown.Handle.ToInt32());
                //SetForegroundWindow(dropdown.Handle.ToInt32());
                //this.SelectNextControl(dropdown, true, true, true, false);
            }
        }
