	...
	begin
		...
		exec(N'If(OBJECT_ID(''tempdb..#UnionTemp'') Is Not Null) '
			...
			begin
				...
				+ 'isnull(s.srvname, ms.subscriber) as SubscriberInstance, ms.subscriber_db, sp.publication, '
				...
				+ 'group by p.srvname, ms.publisher_db, isnull(s.srvname, ms.subscriber), ms.subscriber_db, sp.publication, '
