//------------------------------------------------------------------------------
// <copyright file="AWSProbe.cs" company="Idera, Inc.">
...
namespace Idera.SQLdm.CollectionService.Probes.Sql
{
    ...
    class AWSProbe : SqlBaseProbe
    {
        ...
        /// <summary>
        /// Initializes a new instance of the AWSProbe class.
        /// </summary>
        /// <param name="monitoredServer">The monitored server.</param>
        /// <param name="cloudProviderId">Skips permission check for cloud servers</param>
        public AWSProbe(MonitoredSqlServer monitoredServer, MonitoredServerWorkload workload, int? cloudProviderId)
            : base(monitoredServer.ConnectionInfo)
        {
            ...
            LOG = Logger.GetLogger("AWSProbe:" + monitoredServer.InstanceName);
        ...
        protected override void Start()
        {
            ...
            //{
            //    LOG.Debug("Pushing aws refresh probe to the work queue.");
            //    Collection.QueueDelegate(Start);
            //    return;
            //}

            LOG.Verbose("Starting AWS Refresh");
...
Last Error Log Read: {2}",
        ...
        private void InterpretAWSMetrics(Dictionary<string, double> awsMetrics)
        {
            ...
            refresh.Server.AWSCloudMetrics = awsMetrics;
            refresh.Server.WriteThroughput = 0.67;
            FireCompletion(refresh, Result.Success);
            return;
        }
