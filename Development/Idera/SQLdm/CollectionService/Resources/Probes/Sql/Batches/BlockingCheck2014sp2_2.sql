...
select distinct
	...
	b.waitresource
from 
	sysprocesses p (nolock) 
	left join sysprocesses b (nolock) 
		on p.spid = b.blocked 
	left outer join syslockinfo l (nolock) 
...
begin 
  ...
  BEGIN
	...
	FROM sys.dm_exec_input_buffer(@blockingcheckspid, NULL)
  END
  update @tempblocking 
